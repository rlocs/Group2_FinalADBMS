...
<div class="container top-gap-after-navbar">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            Household profile successfully <?php echo htmlspecialchars($_GET['success']); ?>.
        ...
        <table class="table table-bordered table-hover bg-white">
            ...
            <tbody id="hhprofileTableBody">
                ...
                try {
                    ...
                    if (!empty($search)) {
                        $searchCondition = " WHERE h.head_name LIKE :search";
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="hh_crud.php">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="medical_condition" class="form-control" rows="2" required><?= htmlspecialchars($h['medical_condition']) ?></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label>Allergies</label>
                                                    <textarea name="allergies" class="form-control" rows="2" required><?= htmlspecialchars($h['allergies']) ?></textarea>
                                                </div>
